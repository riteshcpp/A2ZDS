...
int main()
{
    ...
    std::cout << "Test 1: arr = [15, -2, 2, -8, 1, 7, 10, 23], "
              << "Expected: 5, Actual: " << result1 << std::endl;
    assert(result1 == 5);
    ...
    std::cout << "Test 2: arr = [2, 10, 4], "
              << "Expected: 0, Actual: " << result2 << std::endl;
    assert(result2 == 0);
    ...
    std::cout << "Test 3: arr = [1, 0, -4, 3, 1, 0], "
              << "Expected: 5, Actual: " << result3 << std::endl;
    assert(result3 == 5);
    ...
    std::cout << "Test 4: arr = [0], "
              << "Expected: 1, Actual: " << result4 << std::endl;
    assert(result4 == 1);
    ...
    std::cout << "Test 5: arr = [-1, 1, -1, 1], "
              << "Expected: 4, Actual: " << result5 << std::endl;
    assert(result5 == 4);
    ...
    std::cout << "Test 6: arr = [1, -1], "
              << "Expected: 2, Actual: " << result6 << std::endl;
    assert(result6 == 2);
